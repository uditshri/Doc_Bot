...
class ChatInterface(Frame):
    ...
    def msg(self):
        tkinter.messagebox.showinfo("About me :)","I am Doctor Bot or Doc Bot for short. \nYou can ask me about Coronavirus(covid).\n If you want to exit enter Bye.")

    def about(self):
        tkinter.messagebox.showinfo("Doc BOT Developers",
                                    "Uditanshu Shrivastava")
    ...
    def send_message_insert(self, message):
        ...
        self.text_box.configure(state=DISABLED)
        self.text_box.see(END)
        self.last_sent_label(str(time.strftime("Last messa/n "
                                               "mge sent: " + '%B %d, %Y' + ' at ' + '%I:%M %p')))
